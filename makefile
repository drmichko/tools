...
all : projection.exe init.exe schatz.exe action.exe stabredo.exe stab.exe ft.exe  nl.exe test.exe invariant.exe nnl.exe ab.exe anfload.exe print.exe anfsimple.exe rd.exe regroup.exe 
